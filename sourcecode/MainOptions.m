...
%% Object for storing Main Options UI elements
    ...
    methods
        function  obj = MainOptions(CallingTab,CallingData)
            ...
            obj.FileTypeSwitch = uiswitch(obj.Container,...
                Items=["Profile","Centroid"],...
                ItemsData=["profile","centroid"],...
                Position=[85,270,45,20]);
            obj.FileTypeSwitch.Value = CallingData.MSFileType;
            obj.FileTypeLabel  = uilabel(obj.Container,"Text","MS Data Type",...
                "Position",[75,250,100,20],...
                "HorizontalAlignment","center","VerticalAlignment","center",...
                Tooltip="Set the file type of the data. Profile data will be centroided");
            ...
            obj.AddNLossTickBox = uicheckbox(obj.Container,...
                "Value",CallingData.AdductFilter,...
