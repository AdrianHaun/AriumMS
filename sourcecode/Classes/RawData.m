classdef RawData
    ...
    methods
        ...
        function obj = filterIsotopes(obj)
            ...
            for iFile = 1:size(tempPeakData,1)
                tempPeakData{iFile,1} = InScanIsotopeFilter(tempPeakData{iFile,1},MASS_TOLERANCE,MASS_TOLERANCE_UNIT);
            end
        ...
        function OutputStruct = findOriginalMassScans(obj,InputStruct)
            ...
            parfor iScan = 1: length(InputStruct)
                ...
                for jFile = 1:nFile
                    ...
                    spectra{1,jFile} = alignSpectra(scans,"normal","high","false");
                end
    ...
    methods (Static)
        ...
        function integrationStruct = finalizeIntegrationOutput(integrationStruct,times)
            ...
            parfor iFeature = 1:length(integrationStruct)
                eic = full(integrationStruct(iFeature).XIC);S
