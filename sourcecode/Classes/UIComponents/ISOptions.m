        ...
        function obj = ISOptions(CallingTab,CallingData)
            ...
            if nargin > 0
                ...
                obj.ApplyDrop = uidropdown(obj.Container,...
                    "Value",CallingData.applyISto,...
                    "Items",["Samples and Blanks","Samples only"],...
                    "ItemsData",["S&B","SOnly"],...
                    "Position",[105,95,110,20],"Enable",CallingData.useBlankSubtraction,...
                    Tooltip="Specify which files to apply IS normalization to. Use ""Samples only"" if the blank files do not contain IS.");
                obj.ApplyLabel = uilabel(obj.Container,"Text","Apply to","Position",[5,95,90,20],"Enable",CallingData.useBlankSubtraction,HorizontalAlignment="right");

                obj.OrderDrop = uidropdown(obj.Container,...
                    "Value",CallingData.internalStandardOrder,...
                    "Items",["Blank then IS","IS then blank"],...
                    "ItemsData",["BlankIS","ISBlank"],...
                    "Position",[105,65,110,20],...
                    "Enable",CallingData.useBlankSubtraction,...
                    Tooltip="Specify the order of internal standard correction and blank subtraction.");
                obj.OrderLabel = uilabel(obj.Container,"Text","Normalization order","Position",[5,55,90,40],"Enable",CallingData.useBlankSubtraction,HorizontalAlignment="right",WordWrap="on");
