        ...
        function obj = ROIOptions(CallingTab,CallingData)
            ...
            if nargin > 0
                ...
                obj.ThreshField = uieditfield(obj.Container,"numeric", ...
                    ...
                    "Value",CallingData.roiThreshold, ...
                ...
                obj.mzerrorField = uieditfield(obj.Container,"numeric", ...
                    ...
                    "Value",CallingData.withinFileMassTolerance,...
                    Tooltip="m/z difference where ROI masses are considered to be within the same ROI. Recommended setting: Instrument mass accuracy");
                ...
                obj.mzerrorUnitDrop = uidropdown(obj.Container, ...
                    "Items",["ppm","Da"],...
                    ItemsData=["ppm","Da"], ...
                    Value=CallingData.withinFileMassUnit,...
                ...
                obj.minROIField = uieditfield(obj.Container,"numeric", ...
                    ...
                    "Value",CallingData.roiMinOccurrence, ...
                    "RoundFractionalValues","on",...
                ...
                obj.StartTimeField = uieditfield(obj.Container,"numeric", ...
                    ...
                    "Limits",[CallingData.measurementStartTime, CallingData.measurementEndTime], ...
                    "LowerLimitInclusive","on",...
                    "ValueDisplayFormat","%.1f s",...
                    "Value",CallingData.measurementStartTime,...
                ...
                obj.EndTimeField = uieditfield(obj.Container,"numeric", ...
                    ...
                    "Limits",[CallingData.measurementStartTime + 0.1 ,CallingData.measurementEndTime], ...
                    "UpperLimitInclusive","on",...
                    "ValueDisplayFormat","%.1f s",...
                    "Value",CallingData.measurementEndTime,...
