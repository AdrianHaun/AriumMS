    ...
    methods
        function obj = BaseCorrOptions(CallingTab,CallingData)
            ...
            obj.WindowSizeField = uieditfield(obj.Container,"numeric", ...
                ...
                "Value",CallingData.baselineWindowSize, ...
            ...
            obj.StepSizeField = uieditfield(obj.Container,"numeric", ...
                ...
                "Limits",[0.1,Inf], ...
                "ValueDisplayFormat","%.0f s",...
                "Value",CallingData.baselineStepSize, ...
                "RoundFractionalValues","on",...
            ...
            obj.RegressionDrop = uidropdown(obj.Container,...
                "Value",CallingData.baselineRegressionMethod,...
            ...
            obj.EstimationDrop = uidropdown(obj.Container,...
                "Value",CallingData.baselineEstimationMethod,...
            ...
            obj.SmoothDrop = uidropdown(obj.Container,...
                "Value",CallingData.baselineSmoothMethod,...
                "Items",["No Smoothing","Linear fit","Quadratic fit"],...
                "ItemsData",["none","lowess","loess"],...
            ...
            obj.QuantilValField = uieditfield(obj.Container,"numeric", ...
                ...
                "Value",CallingData.baselineQuantil, ...
