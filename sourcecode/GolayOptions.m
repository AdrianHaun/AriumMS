    ...
    methods
        function obj = GolayOptions(CallingTab,CallingData)
            ...
            obj.FrameSize = uieditfield(obj.Container,"numeric",...
                ...
                Tooltip="Moving Frame Size. Higher values smooth the signal more with an increase in computation time");
            ...
            obj.Degree = uieditfield(obj.Container,"numeric",...
                ...
                RoundFractionalValues="on",...
                Tooltip="Specifies the degree of the polynomial fitted to the points in the moving frame");
